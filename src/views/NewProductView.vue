...
const fetchNewProductsAndCoupons = async () => {
  ...
  if (newProductData.responses) {
    const productsWithCoupons = await fetchCoupons(newProductData.responses)
    newProducts.value = productsWithCoupons
  }
}
...
<template>
  <div class="product-search-container">
    <div class="product-search-result">
      <p class="search-label">신상품</p>
    </div>
    <div v-if="newProducts.length !== 0" class="product-list-container">
      <RouterLink
        class="prod-info"
